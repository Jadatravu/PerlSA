...
for data in f.readlines():
    ...
    """
      ...
      curl -X POST -u "user:password" --data "file_name=\"one.pl\"&description=\"one two three four\"&severity=0&line=100&column=10" http://127.0.0.1:8000/IssueStatus/ 
    """
    ...
    update_issue_url = 'http://127.0.0.1:9000/IssueStatus/'   
